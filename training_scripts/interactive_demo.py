...
def main():
    ...
    parser.add_argument('--model', default='./xmem_checkpoints/XMem.pth')
    parser.add_argument('--s2m_model', default='xmem_checkpoints/s2m.pth')
    parser.add_argument('--fbrs_model', default='xmem_checkpoints/fbrs.pth')
    ...
    parser.add_argument('--dataset', help='Name of the dataset to load from. See scripts/datasets.py for details.', required=True)
    ...
    dataset_folder_name = args.dataset.split("/")[-1].replace(".hdf5", "")
    # args.images = workspace_folder_name
    demo_idx = 0
    img_idx = 0
